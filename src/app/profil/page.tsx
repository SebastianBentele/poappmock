...
const buildPersonal = (t: Tr): Field[] => [
  { key: "firstName", label: t("Vorname", "First name"), value: "Sebastian" },
  { key: "lastName", label: t("Nachname", "Last name"), value: "Bentele" },
  { key: "company", label: t("Firma (optional)", "Company (optional)"), value: "Bentele Immobilien GmbH", span: true },
  { key: "email", label: t("E-Mail", "Email"), value: "sebastian@arbio.com" },
  { key: "phone", label: t("Telefon", "Phone"), value: "+49 170 1234567" },
  { key: "street", label: t("Straße & Hausnr.", "Street & no."), value: "Maximilianstraße 12", span: true },
  { key: "zip", label: t("PLZ", "Postal code"), value: "80539" },
  { key: "city", label: t("Stadt", "City"), value: "München" },
  { key: "country", label: t("Land", "Country"), value: t("Deutschland", "Germany") },
  { key: "taxId", label: t("Steuernummer / USt-IdNr.", "Tax number / VAT ID"), value: "DE812345678" },
];

const buildBank = (t: Tr): Field[] => [
  { key: "accountHolder", label: t("Kontoinhaber", "Account holder"), value: "Sebastian Bentele", span: true },
...
const buildContractTerms = (t: Tr): { label: string; value: string; active?: boolean }[] => [
  { label: t("Vertragsmodell", "Contract model"), value: "Full-Service Management" },
  { label: t("Management-Gebühr", "Management fee"), value: t("15% vom Nettoumsatz", "15% of net revenue") },
  { label: t("Vertragsbeginn", "Contract start"), value: "01.03.2025" },
  { label: t("Mindestlaufzeit", "Minimum term"), value: t("12 Monate", "12 months") },
  { label: t("Kündigungsfrist", "Notice period"), value: t("3 Monate zum Laufzeitende", "3 months to end of term") },
  { label: t("Verwaltete Einheiten", "Managed units"), value: t("5 Einheiten", "5 units") },
  { label: t("Auszahlungsrhythmus", "Payout schedule"), value: t("Monatlich, zum 5.", "Monthly, on the 5th") },
  { label: t("Status", "Status"), value: t("Aktiv", "Active"), active: true },
];

const buildDocuments = (t: Tr) => [
  { name: t("Management-Vertrag", "Management contract"), meta: t("PDF · unterzeichnet 24.02.2025 · 4 Seiten", "PDF · signed 24.02.2025 · 4 pages") },
  { name: t("Leistungsbeschreibung (Anhang A)", "Statement of services (Annex A)"), meta: t("PDF · 24.02.2025 · 2 Seiten", "PDF · 24.02.2025 · 2 pages") },
  { name: t("Preisblatt & Gebühren (Anhang B)", "Price sheet & fees (Annex B)"), meta: t("PDF · 24.02.2025 · 1 Seite", "PDF · 24.02.2025 · 1 page") },
];

// Monthly management-fee invoices, newest first
const buildInvoices = (t: Tr) => {
  const inv = (de: string, en: string) => t(`Rechnung ${de}`, `${en} invoice`);
  const cr = (d: string, amt: string) => t(`· erstellt ${d} · ${amt}`, `· created ${d} · ${amt}`);
  return [
    { name: inv("Juni 2026", "June 2026"), meta: `RE-2026-06 ${cr("05.07.2026", "€5.204")}` },
    { name: inv("Mai 2026", "May 2026"), meta: `RE-2026-05 ${cr("05.06.2026", "€4.787")}` },
    { name: inv("April 2026", "April 2026"), meta: `RE-2026-04 ${cr("05.05.2026", "€4.573")}` },
    { name: inv("März 2026", "March 2026"), meta: `RE-2026-03 ${cr("05.04.2026", "€3.998")}` },
    { name: inv("Februar 2026", "February 2026"), meta: `RE-2026-02 ${cr("05.03.2026", "€2.860")}` },
    { name: inv("Januar 2026", "January 2026"), meta: `RE-2026-01 ${cr("05.02.2026", "€2.512")}` },
    { name: inv("Dezember 2025", "December 2025"), meta: `RE-2025-12 ${cr("05.01.2026", "€2.744")}` },
    { name: inv("November 2025", "November 2025"), meta: `RE-2025-11 ${cr("05.12.2025", "€2.688")}` },
    { name: inv("Oktober 2025", "October 2025"), meta: `RE-2025-10 ${cr("05.11.2025", "€3.317")}` },
  ];
};
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[15px] text-muted mt-0.5">
            {t("Property Owner · seit März 2025 · 5 Einheiten", "Property Owner · since March 2025 · 5 units")}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 mt-7">
        ...
        <div className="bg-white border border-line rounded-[24px] p-7 shadow-[0_1px_4px_rgba(0,0,0,0.03)]">
          <div className="flex items-center gap-2.5 mb-1">
            ...
            <h3 className="text-[16px]">{t("Persönliche Daten", "Personal details")}</h3>
          </div>
          <div className="-mt-9">
        ...
        <CollapsibleCard
          title={t("Bankverbindung", "Bank details")}
          subtitle={t("Konto für deine Auszahlungen", "Account for your payouts")}
          icon={Landmark}
        >
          ...
          <div className="flex items-center gap-2 mt-4 text-[13px] text-muted">
            ...
            {t(
              "Deine Auszahlungen gehen auf dieses Konto. Änderungen werden aus Sicherheitsgründen geprüft, bevor sie aktiv werden.",
              "Your payouts go to this account. Changes are reviewed for security reasons before they take effect."
            )}
          </div>
        </CollapsibleCard>
        ...
        >
          <div className="grid grid-cols-2 gap-x-6 gap-y-5">
            {contractTerms.map(({ label, value, active }) => (
              <div key={label}>
          ...
          <div className="border-t border-line mt-6 pt-5">
            <h4 className="text-[15px]">{t("Dokumente", "Documents")}</h4>
        ...
        <CollapsibleCard
          title={t("Rechnungen", "Invoices")}
          subtitle={t("Monatliche Rechnungen über die Management-Gebühr", "Monthly invoices for the management fee")}
          icon={Receipt}
          headerRight={
            <span className="text-[13px] text-muted shrink-0 mr-2">{t(`${invoices.length} Rechnungen`, `${invoices.length} invoices`)}</span>
          }
        >
